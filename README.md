...
<!-- Profile Picture -->
<img src="./hello-world.png" alt="Hello World" width="70%">
...
$name = "Mahdi";
$age = 16;
$interested_in = array("Web Development", "Pentesting");
